        ...
        <div className="footer-container">
          ...
          <div className="footer-info">
              ...
              <div className="footer-logo-flex-container">
                <div className="footer-logos">
                  <div className="footer--logo">
                    <a href="#">
                      <img src={insta_logo} alt="Instagram Icon" />
                    </a>
                  </div>
            ...
            <div className="footer-about">
              <h4>About us</h4>
              <p>
                We are students of JC BOSE UNIVERSITY OF SCIENCE AND TECHNOLOGY
                , currently studying in 3rd sem B.Tech Computer Engineering .
                This site is developed as a News Project for 3rd sem Minor
                Project.
              </p>
            </div>
          </div>
